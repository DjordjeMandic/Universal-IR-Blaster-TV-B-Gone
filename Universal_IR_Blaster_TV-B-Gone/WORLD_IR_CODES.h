...
Universal IR Blaster TV-B-Gone V1.0
Ported by Djrodje Mandic 23 Feb 2021
Moved EU and NA ir code pointer arrays to their respective files
https://github.com/DjordjeMandic
https://youtube.com/c/ncky
...
/*const uint16_t irNECTimes[] PROGMEM = { // nec
 
   56, 56, // 0.56ms on 0.56ms off (logic 0)
 
   56, 167, // 0.56ms on 1.67ms off (logic 1)
 
   900, 450, // 9ms on 4.5ms off (AGC-LPAUSE)
   56, 0, // 0.56ms on 0ms off (stop)
 
};
*/


#include "IrCodes_Eu.h"
#include "IrCodes_Na.h"
