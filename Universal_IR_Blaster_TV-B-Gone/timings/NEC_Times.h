...
const uint16_t NEC_Times[] PROGMEM = {
    NEC_BIT_LEN, NEC_LOGIC_ZERO_LEN, // 0.56ms on 0.56ms off (logic 0)
    NEC_BIT_LEN, NEC_LOGIC_ONE_LEN,  // 0.56ms on 1.69ms off (logic 1)
    NEC_AGC_LEN, NEC_LONG_PAUSE_LEN, // 9ms on 4.5ms off (AGC-LPAUSE)
    NEC_BIT_LEN, 0,                  // 0.56ms on 0ms off (stop)
};
